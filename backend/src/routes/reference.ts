...
function commonDataAvailabilityVolatileHtml(data: RegularFile | ModelFile) {
  ...
  const datastr = `\
      The ground-based remote-sensing data used in this article are generated by Aerosol, Clouds and Trace Gases Research Infrastructure (ACTRIS) and are available from the ACTRIS Data Centre using the following link:
