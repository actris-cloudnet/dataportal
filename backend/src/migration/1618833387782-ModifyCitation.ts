...
export class ModifyCitation1618833387782 implements MigrationInterface {
    name = 'ModifyCitation1618833387782'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "model_citations_model_citation" ("modelId" character varying NOT NULL, "modelCitationId" integer NOT NULL, CONSTRAINT "PK_97e977fae702ddd1531f9a58f45" PRIMARY KEY ("modelId", "modelCitationId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "site_citations_regular_citation" ("siteId" character varying NOT NULL, "regularCitationId" integer NOT NULL, CONSTRAINT "PK_ae102e9377f3411d40228981b86" PRIMARY KEY ("siteId", "regularCitationId"))`);
