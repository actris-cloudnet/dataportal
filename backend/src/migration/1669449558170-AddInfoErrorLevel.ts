...
export class AddInfoErrorLevel1669449558170 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."file_quality_errorlevel_enum" RENAME TO "file_quality_errorlevel_enum_old"`,
    );
    await queryRunner.query(`CREATE TYPE "file_quality_errorlevel_enum" AS ENUM('pass', 'info', 'warning', 'error')`);
    await queryRunner.query(
      `ALTER TABLE "file_quality" ALTER COLUMN "errorLevel" TYPE "file_quality_errorlevel_enum" USING "errorLevel"::"text"::"file_quality_errorlevel_enum"`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."quality_report_result_enum" RENAME TO "quality_report_result_enum_old"`,
    );
    await queryRunner.query(`CREATE TYPE "quality_report_result_enum" AS ENUM('pass', 'info', 'warning', 'error')`);
    await queryRunner.query(
      `ALTER TABLE "quality_report" ALTER COLUMN "result" TYPE "quality_report_result_enum" USING "result"::"text"::"quality_report_result_enum"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "file" ALTER COLUMN "errorLevel" TYPE "file_errorlevel_enum" USING "errorLevel"::"text"::"file_errorlevel_enum"`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."regular_file_errorlevel_enum" RENAME TO "regular_file_errorlevel_enum_old"`,
    );
    await queryRunner.query(`CREATE TYPE "regular_file_errorlevel_enum" AS ENUM('pass', 'info', 'warning', 'error')`);
    await queryRunner.query(
      `ALTER TABLE "regular_file" ALTER COLUMN "errorLevel" TYPE "regular_file_errorlevel_enum" USING "errorLevel"::"text"::"regular_file_errorlevel_enum"`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."model_file_errorlevel_enum" RENAME TO "model_file_errorlevel_enum_old"`,
    );
    await queryRunner.query(`CREATE TYPE "model_file_errorlevel_enum" AS ENUM('pass', 'info', 'warning', 'error')`);
    await queryRunner.query(
      `ALTER TABLE "model_file" ALTER COLUMN "errorLevel" TYPE "model_file_errorlevel_enum" USING "errorLevel"::"text"::"model_file_errorlevel_enum"`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."search_file_errorlevel_enum" RENAME TO "search_file_errorlevel_enum_old"`,
    );
    await queryRunner.query(`CREATE TYPE "search_file_errorlevel_enum" AS ENUM('pass', 'info', 'warning', 'error')`);
    await queryRunner.query(
      `ALTER TABLE "search_file" ALTER COLUMN "errorLevel" TYPE "search_file_errorlevel_enum" USING "errorLevel"::"text"::"search_file_errorlevel_enum"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "search_file" ALTER COLUMN "errorLevel" TYPE "search_file_errorlevel_enum_old" USING "errorLevel"::"text"::"search_file_errorlevel_enum_old"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "model_file" ALTER COLUMN "errorLevel" TYPE "model_file_errorlevel_enum_old" USING "errorLevel"::"text"::"model_file_errorlevel_enum_old"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "regular_file" ALTER COLUMN "errorLevel" TYPE "regular_file_errorlevel_enum_old" USING "errorLevel"::"text"::"regular_file_errorlevel_enum_old"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "file" ALTER COLUMN "errorLevel" TYPE "file_errorlevel_enum_old" USING "errorLevel"::"text"::"file_errorlevel_enum_old"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "quality_report" ALTER COLUMN "result" TYPE "quality_report_result_enum_old" USING "result"::"text"::"quality_report_result_enum_old"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "file_quality" ALTER COLUMN "errorLevel" TYPE "file_quality_errorlevel_enum_old" USING "errorLevel"::"text"::"file_quality_errorlevel_enum_old"`,
    );
