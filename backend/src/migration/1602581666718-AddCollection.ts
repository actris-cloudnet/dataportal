...
export class AddCollection1602581666718 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "collection" ("uuid" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, CONSTRAINT "PK_3be7c065e8288915cd60b52bf0a" PRIMARY KEY ("uuid"))`
    );
    await queryRunner.query(
      `CREATE TABLE "collection_files_file" ("collectionUuid" uuid NOT NULL, "fileUuid" uuid NOT NULL, CONSTRAINT "PK_769caf6e6e7f33fd4a6ced04b26" PRIMARY KEY ("collectionUuid", "fileUuid"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_094919863be141393570945026" ON "collection_files_file" ("collectionUuid") `
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "collection_files_file" ADD CONSTRAINT "FK_094919863be141393570945026d" FOREIGN KEY ("collectionUuid") REFERENCES "collection"("uuid") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "collection_files_file" ADD CONSTRAINT "FK_cf576dd45955b2a78d162275155" FOREIGN KEY ("fileUuid") REFERENCES "file"("uuid") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
  }
