...
export class AddInvalidStatus1629194180622 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "upload" ALTER COLUMN "status" TYPE "upload_status_enum" USING "status"::"text"::"upload_status_enum"`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "instrument_upload_status_enum" AS ENUM('created', 'uploaded', 'processed', 'invalid')`,
    );
    await queryRunner.query(`ALTER TABLE "instrument_upload" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "instrument_upload" ALTER COLUMN "status" TYPE "instrument_upload_status_enum" USING "status"::"text"::"instrument_upload_status_enum"`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "model_upload_status_enum" AS ENUM('created', 'uploaded', 'processed', 'invalid')`,
    );
    await queryRunner.query(`ALTER TABLE "model_upload" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "model_upload" ALTER COLUMN "status" TYPE "model_upload_status_enum" USING "status"::"text"::"model_upload_status_enum"`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "misc_upload_status_enum" AS ENUM('created', 'uploaded', 'processed', 'invalid')`,
    );
    await queryRunner.query(`ALTER TABLE "misc_upload" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "misc_upload" ALTER COLUMN "status" TYPE "misc_upload_status_enum" USING "status"::"text"::"misc_upload_status_enum"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "misc_upload" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "misc_upload" ALTER COLUMN "status" TYPE "misc_upload_status_enum_old" USING "status"::"text"::"misc_upload_status_enum_old"`,
    );
    await queryRunner.query(`ALTER TABLE "misc_upload" ALTER COLUMN "status" SET DEFAULT 'created'`);
    ...
    await queryRunner.query(`ALTER TABLE "model_upload" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "model_upload" ALTER COLUMN "status" TYPE "model_upload_status_enum_old" USING "status"::"text"::"model_upload_status_enum_old"`,
    );
    await queryRunner.query(`ALTER TABLE "model_upload" ALTER COLUMN "status" SET DEFAULT 'created'`);
    ...
    await queryRunner.query(`ALTER TABLE "instrument_upload" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "instrument_upload" ALTER COLUMN "status" TYPE "instrument_upload_status_enum_old" USING "status"::"text"::"instrument_upload_status_enum_old"`,
    );
    await queryRunner.query(`ALTER TABLE "instrument_upload" ALTER COLUMN "status" SET DEFAULT 'created'`);
    ...
    await queryRunner.query(`ALTER TABLE "upload" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "upload" ALTER COLUMN "status" TYPE "upload_status_enum_old" USING "status"::"text"::"upload_status_enum_old"`,
    );
    await queryRunner.query(`ALTER TABLE "upload" ALTER COLUMN "status" SET DEFAULT 'created'`);
