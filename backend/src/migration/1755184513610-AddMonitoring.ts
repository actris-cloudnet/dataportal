...
export class AddMonitoring1755184513610 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "instrument_derived_monitoring_products_monitoring_product" ("instrumentId" character varying NOT NULL, "monitoringProductId" character varying NOT NULL, CONSTRAINT "PK_9ef738b22f42557f622709f7cce" PRIMARY KEY ("instrumentId", "monitoringProductId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c52fd36031e40cbc415c3e4dfe" ON "instrument_derived_monitoring_products_monitoring_product" ("instrumentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f30bc7fc3e1c6bc9b608338e5a" ON "instrument_derived_monitoring_products_monitoring_product" ("monitoringProductId") `);
        await queryRunner.query(`ALTER TABLE "monitoring_file" ADD CONSTRAINT "FK_2ba3a42aed9fffa0cdc7ba98c29" FOREIGN KEY ("siteId") REFERENCES "site"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "monitoring_file" ADD CONSTRAINT "FK_c7935b1ef38197e8befda2a7293" FOREIGN KEY ("monitoringProductId") REFERENCES "monitoring_product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "monitoring_file" ADD CONSTRAINT "FK_25a25dfc95a5abe15ed42f1b001" FOREIGN KEY ("instrumentInfoUuid") REFERENCES "instrument_info"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "monitoring_visualization" ADD CONSTRAINT "FK_9aaefbae94b2a460e119540a453" FOREIGN KEY ("sourceFileUuid") REFERENCES "monitoring_file"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "monitoring_visualization" ADD CONSTRAINT "FK_92e29a5d29883e3f93a2d7a9683" FOREIGN KEY ("monitoringProductVariableId") REFERENCES "monitoring_product_variable"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "monitoring_product_variable" ADD CONSTRAINT "FK_4ef6bcb326316ff563c7df4f1c7" FOREIGN KEY ("monitoringProductId") REFERENCES "monitoring_product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "instrument_derived_monitoring_products_monitoring_product" ADD CONSTRAINT "FK_c52fd36031e40cbc415c3e4dfe9" FOREIGN KEY ("instrumentId") REFERENCES "instrument"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "instrument_derived_monitoring_products_monitoring_product" ADD CONSTRAINT "FK_f30bc7fc3e1c6bc9b608338e5a0" FOREIGN KEY ("monitoringProductId") REFERENCES "monitoring_product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "instrument_derived_monitoring_products_monitoring_product" DROP CONSTRAINT "FK_f30bc7fc3e1c6bc9b608338e5a0"`);
        await queryRunner.query(`ALTER TABLE "instrument_derived_monitoring_products_monitoring_product" DROP CONSTRAINT "FK_c52fd36031e40cbc415c3e4dfe9"`);
        await queryRunner.query(`ALTER TABLE "monitoring_product_variable" DROP CONSTRAINT "FK_4ef6bcb326316ff563c7df4f1c7"`);
