...
export class RemoveSynergeticProductType1723537548574 implements MigrationInterface {
  name = "RemoveSynergeticProductType1723537548574";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TYPE "public"."product_type_enum" RENAME TO "product_type_enum_old"`);
    await queryRunner.query(
      `CREATE TYPE "public"."product_type_enum" AS ENUM('instrument', 'model', 'geophysical', 'evaluation', 'experimental')`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."product_type_enum_old" AS ENUM('instrument', 'model', 'synergetic', 'evaluation', 'experimental', 'geophysical')`,
    );
    await queryRunner.query(`ALTER TABLE "product" ALTER COLUMN "type" DROP DEFAULT`);
    await queryRunner.query(
