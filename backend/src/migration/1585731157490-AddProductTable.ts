...
export class AddProductTable1585731157490 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      `CREATE TABLE "product" ("id" character varying NOT NULL, "humanReadableName" character varying NOT NULL, "level" character varying NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`,
      undefined
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."file_product_enum" AS ENUM('categorize', 'classification', 'drizzle', 'iwc', 'lidar', 'lwc', 'model', 'mwr', 'radar')`,
      undefined
    );
