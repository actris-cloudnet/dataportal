...
export class SeparateModelFilesFromInstrumentFiles1612274263557 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      // MODEL FILE
        await queryRunner.query(`CREATE TABLE "model_file" ("uuid" uuid NOT NULL, "s3key" character varying NOT NULL, "version" character varying NOT NULL, "pid" character varying NOT NULL DEFAULT '', "volatile" boolean NOT NULL DEFAULT true, "legacy" boolean NOT NULL DEFAULT false, "measurementDate" date NOT NULL, "history" character varying NOT NULL DEFAULT '', "cloudnetpyVersion" character varying NOT NULL DEFAULT '', "checksum" character varying NOT NULL, "size" integer NOT NULL, "format" character varying NOT NULL, "sourceFileIds" text array, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "siteId" character varying, "productId" character varying, "modelId" character varying, CONSTRAINT "UQ_c12dee99fecddb342ac1b1c865d" UNIQUE ("checksum"), CONSTRAINT "PK_fc253af1bf074f42da1c667ac6b" PRIMARY KEY ("uuid"))`);
