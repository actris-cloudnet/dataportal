...
export class AddIdFieldToUploadedMetadata1598441033679 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "uploaded_metadata" ADD CONSTRAINT "PK_fd5803d4d32d211ba19b1d10bc8" PRIMARY KEY ("hash", "id")`
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."uploaded_metadata_status_enum" RENAME TO "uploaded_metadata_status_enum_old"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "uploaded_metadata" ALTER COLUMN "status" TYPE "uploaded_metadata_status_enum" USING "status"::"text"::"uploaded_metadata_status_enum"`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "uploaded_metadata" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "uploaded_metadata" ALTER COLUMN "status" TYPE "uploaded_metadata_status_enum_old" USING "status"::"text"::"uploaded_metadata_status_enum_old"`
    );
    await queryRunner.query(`ALTER TABLE "uploaded_metadata" ALTER COLUMN "status" SET DEFAULT 'created'`);
    await queryRunner.query(`DROP TYPE "uploaded_metadata_status_enum"`);
    await queryRunner.query(
      `ALTER TYPE "uploaded_metadata_status_enum_old" RENAME TO  "uploaded_metadata_status_enum"`
    );
    ...
    await queryRunner.query(`ALTER TABLE "uploaded_metadata" DROP CONSTRAINT "PK_fd5803d4d32d211ba19b1d10bc8"`);
    await queryRunner.query(
      `ALTER TABLE "uploaded_metadata" ADD CONSTRAINT "PK_11dd39e009aacff3f24931e7eae" PRIMARY KEY ("hash")`
    );
