...
export class LinkSiteToUploadedMetadata1597314062388 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "uploaded_metadata" ADD CONSTRAINT "FK_8c3a6b9b7bf50681a30bc06c703" FOREIGN KEY ("siteId") REFERENCES "site"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
