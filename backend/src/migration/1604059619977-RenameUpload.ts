...
export class RenameUpload1604059619977 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "upload" ("uuid" uuid NOT NULL, "hashSum" character varying(32) NOT NULL, "filename" character varying NOT NULL, "measurementDate" date NOT NULL, "status" "upload_status_enum" NOT NULL DEFAULT 'created', "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "siteId" character varying, "instrumentId" character varying, CONSTRAINT "UQ_48edc87d9256941d0176bd4e3cd" UNIQUE ("hashSum"), CONSTRAINT "PK_8c4478cf0c29280ac23906112c7" PRIMARY KEY ("uuid"))`
    );
    await queryRunner.query(
