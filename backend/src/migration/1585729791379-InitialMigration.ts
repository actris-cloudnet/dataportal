...
export class InitialMigration1585729791379 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "file" (
            ...
            "publicity" "file_publicity_enum" NOT NULL DEFAULT 'public', 
            "product" "file_product_enum" NOT NULL, 
            "cloudnetpyVersion" character varying, 
            ...
            CONSTRAINT "PK_d85c96c207a7395158a68ee1265" PRIMARY KEY ("uuid"))`, undefined);
