...
export class AddPermission1651133557527 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "permission" ("id" SERIAL NOT NULL, "permission" character varying NOT NULL, "siteId" character varying, CONSTRAINT "UQ_4324fae3897bceb10a6fa430871" UNIQUE ("permission", "siteId"), CONSTRAINT "PK_3b8b97af9d9d8807e41e6f48362" PRIMARY KEY ("id"))`);
