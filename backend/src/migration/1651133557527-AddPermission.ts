...
export class AddPermission1651133557527 implements MigrationInterface {
  name = "AddPermission1651133557527";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "permission" ("id" SERIAL NOT NULL, "permission" character varying NOT NULL, "siteId" character varying, CONSTRAINT "UQ_4324fae3897bceb10a6fa430871" UNIQUE ("permission", "siteId"), CONSTRAINT "PK_3b8b97af9d9d8807e41e6f48362" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "user_account_permissions_permission" ("userAccountId" integer NOT NULL, "permissionId" integer NOT NULL, CONSTRAINT "PK_e14a5fbcd230726e5fec8a52a2b" PRIMARY KEY ("userAccountId", "permissionId"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_82e013aa5ee3adefcbf8e7d642" ON "user_account_permissions_permission" ("userAccountId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_acedc388d22fa9f1a1087bd3a0" ON "user_account_permissions_permission" ("permissionId") `
    );
    await queryRunner.query(
