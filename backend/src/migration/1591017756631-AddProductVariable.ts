...
export class AddProductVariable1591017756631 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      `CREATE TABLE "product_variable" ("id" character varying NOT NULL, "humanReadableName" character varying NOT NULL, "order" character varying NOT NULL, CONSTRAINT "PK_b934bb1d8b07039a36dde2c9d3c" PRIMARY KEY ("id"))`,
      undefined,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "visualization" ADD "variableHumanReadableName" character varying NOT NULL`,
      undefined,
    );
